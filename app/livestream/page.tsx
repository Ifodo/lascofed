...
export default async function LiveStreamPage() {
  ...
  return (
    <div className="bg-slate-50 text-slate-900">
      ...
      <main className="mx-auto max-w-7xl space-y-10 px-5 py-10 md:px-8 md:py-14">
        <section className="rounded-3xl bg-linear-to-r from-slate-900 via-red-900 to-slate-900 px-6 py-10 text-white shadow-xl md:px-10 md:py-12">
          ...
          <h1 className="mt-4 text-3xl font-bold leading-tight md:text-5xl">COOP Online Radio & TV</h1>
        ...
        <section className="grid gap-6 lg:grid-cols-[1.7fr,1fr]">
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
            ...
            <LiveVideoPlayer
              ...
              className="mx-auto mt-4 aspect-video w-full max-w-3xl rounded-xl bg-black"
            />
          </article>
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
            ...
            <audio controls preload="none" className="mt-5 w-full" src={settings.radioStreamUrl}>
              Your browser does not support the audio element.
            </audio>

            <a
              href={settings.radioStreamUrl}
              target="_blank"
              rel="noopener noreferrer"
